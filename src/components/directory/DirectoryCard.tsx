...
import { MapPin, Briefcase, Building2, TrendingUp, Landmark, ExternalLink } from 'lucide-react';
...
export function DirectoryCard({ profile }: DirectoryCardProps) {
  ...
  const getHeadline = () => {
    switch (profile.account_type) {
      ...
      case 'investor':
        return profile.investor_type ? `${profile.investor_type} Investor` : 'Investor';
      case 'government':
