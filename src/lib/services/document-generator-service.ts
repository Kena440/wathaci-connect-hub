 ...
 * 
 * This service provides both a comprehensive Supabase-based implementation
 * and a simpler API-client based interface for flexibility.
 */
...
// Simple API-based interface for backend integration (from V3)
...
export type { DocumentType, PaymentStatus, GenerationStatus, PaidDocumentRequest } from '@/@types/database';
