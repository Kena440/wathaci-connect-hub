    ...
    business_stats: [
      {
        ...
        unit: 'users',
        description: 'Distinct profiles across all account types',
        is_active: true,
        order_index: 0,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString()
      ...
      {
        id: 'stat_smes',
        stat_type: 'smes_supported',
        metric_key: 'smes_supported',
        stat_value: 125,
        value: 125,
      ...
      {
        id: 'stat_freelancers',
        stat_type: 'freelancers_active',
        metric_key: 'freelancers_active',
        stat_value: 310,
        value: 310,
      ...
      },
      {
        ...
        unit: 'people',
        description: 'Community and philanthropic supporters',
        is_active: true,
        order_index: 5,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString()
      ...
      {
        id: 'stat_funding',
        stat_type: 'total_funding_zmw',
        metric_key: 'total_funding_zmw',
        stat_value: 78000,
        value: 78000,
        label: 'Total Funding Processed',
        unit: 'ZMW',
        description: 'Sum of completed transactions',
        is_active: true,
        order_index: 6,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString()
      ...
      {
        id: 'stat_projects',
        stat_type: 'projects_completed',
        metric_key: 'projects_completed',
        stat_value: 64,
        value: 64,
        label: 'Projects Completed',
        unit: 'projects',
        description: 'Orders or initiatives delivered',
        is_active: true,
        order_index: 7,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString()
      ...
      {
        id: 'stat_jobs',
        stat_type: 'jobs_supported',
        metric_key: 'jobs_supported',
        stat_value: 890,
        value: 890,
        label: 'Jobs Supported',
        unit: 'jobs',
        description: 'Employment opportunities supported by SMEs',
        is_active: true,
        order_index: 8,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString()
      ...
      {
        id: 'stat_countries',
        stat_type: 'countries_served',
        metric_key: 'countries_served',
        stat_value: 6,
        value: 6,
